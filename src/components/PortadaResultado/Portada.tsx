...
const Portada: React.FC = () => {
  ...
  return (
    ...
    id="portadaDetalle"
    style={{
        backgroundImage: 'linear-gradient(to bottom,rgba(36, 36, 32, 0),rgba(36, 36, 32, 0.93)), url("img_portada")',
                ...
                <div className='proyectoInfo'>
                    <div className='proyectoEtiqueta'>
                        <div className="proyectoUbicacion">
                            ...
                            <Text variant="bodyRegular" color="#EFEFEF">ubicacion</Text>
                        </div>
                        <div className="buttonProyecto"><Text variant="bodyBold" color="white">Vivienda tipo_vivienda</Text></div>
                    </div>
                    <Text variant="headlineRegular" color="#EFEFEF">nombre</Text>
                    <Text variant="cardSubtitle" color="#EFEFEF">Precios desde precio</Text>
                </div>
                <div className='proyectoLogo'>
                    <img src="img_logo" alt="Nombre del proyecto" />
                </div>
            </div>
            <div className='derechaInfo'>
                <div className='proyectoSlogan'>
                    <Text variant="sectionTitle" color="#666666">slogan_1</Text>
                    <Text variant="bodyRegular" color="#666666">texto_intro</Text>
                </div>
                <div className='proyectoDispo'>
                    <div className='proyectoFecha'>
                        ...
                        <div className="proyectoFechaNum">
                           <Text variant="subtitle" color="#2C2B2B">fecha_entrega</Text>
                            <Text variant="subtitle" color="#2C2B2B">del fecha_entrega</Text> 
                        </div>
                    ...
                    <div className='proyectoDisponibilidad'>
                        ...
                        <div className="proyectoDipsText">
                            <Text variant="subtitle" color="#2C2B2B">inventario_apt Aptos</Text>
                            <Text variant="subtitle" color="#2C2B2B">inventario_torres Torres</Text>
                        </div>
